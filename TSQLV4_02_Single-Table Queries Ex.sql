...
from Sales.Orders
order by orderid
OFFSET 307 ROWS FETCH NEXT 30 ROWS ONLY;*/

select orderid, orderdate, custid, empid
from Sales.Orders
where orderdate >= cast('20150601' as date) and orderdate < cast('20150701' as date)
order by orderid;
...
from Sales.Orders
where orderdate >= cast('20150101' as date) and orderdate < cast('20160101' as date)
